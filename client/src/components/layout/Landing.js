                ...
                <div className="container">
                    ...
                    <div className="signup">
                        <div className="doctor-signup">
                            ...
                            <p className="item description">if you are a new doctor signup here!</p>
                        ...
                        <div className="user-signup">
                            ...
                            <p className="item special description">If you are a new Patient sign up here!</p>
                    ...
                    <div className="img">
                        <div className="img-1">
                            <img src={require("../../img/ShutterstockVR.png")}  />
                        </div>
                    </div>
                </div>
                <br />
